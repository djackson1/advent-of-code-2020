...
const { createSortedInputs, findAdapterJoltageDifference } = require('./main')

describe('day 10', () => {
  beforeEach(function () {
    this.inputs1 = createSortedInputs(getInputs(10, { filepath: 'input1.spec.txt', fn: Number }))
    this.inputs2 = createSortedInputs(getInputs(10, { filepath: 'input2.spec.txt', fn: Number }))
  })
